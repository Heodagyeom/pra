package com.example.andsudialog
...
import com.example.andsudialog.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.btn3Date.setOnClickListener {
            val calendar = Calendar.getInstance() // 오늘날짜 갖고 오는 것.
...
//            // 권장하진 않지만 사용은 가능하다.
//            var pro = ProgressDialog.show(this, "타이틀입니다.", "메시지입니다.") // 선생님은 var 안 사용했는데 되심. 왜 난 안돼?
//
//
//            // 핸들러를 통해서 종료 작업을 한다.
//            val handler = Handler()
...
//        } // 더이 상 권장하지 않고 있다. ProgressDialog 를.
        ...
        binding.btn5Porgress.setOnClickListener {
            ...
            builder.show()
        } // xml 파일 추가했음. progressbar 을  다른곳에서 다 되면 디스미스?를 이용하여 종료하면 된다.
